const translations = {
    ko: {
        ...
        privacy_v5: "개인정보 처리방침 (뚝딱 AI 작곡가)",
        terms_ihaveacat: "서비스 이용약관 (나도 있어 고양이)",
        terms_tuktak: "서비스 이용약관 (뚝딱 AI 작곡가)",
    ...
    en: {
        ...
        arc_box5_label: "Document",
        arc_box5_title: "Terms of Service",
        arc_box5_desc: "Terms of service for the services developed.",
        header_ongoing: "Ongoing Projects",
        header_legacy: "Legacy Projects",
        header_privacy: "Privacy Policy",
        header_terms: "Terms of Service",
        ...
        back_to_terms: "Back to Terms List",
        terms_desc: "Terms of service regarding the services developed.",
        social_github: "GitHub",
        social_instagram: "Instagram",
        social_naverblog: "Naver Blog",
        header_prod_web: "Premium Web App",
        ...
        privacy_v5: "Privacy Policy (Tuktak AI Composer)",
        terms_ihaveacat: "Terms of Service (I Have A Cat)",
        terms_tuktak: "Terms of Service (Tuktak AI Composer)",
    ...
    es: {
        ...
        arc_box5_label: "Documento",
        arc_box5_title: "Términos de servicio",
        arc_box5_desc: "Términos de servicio para los servicios desarrollados.",
        header_ongoing: "Proyectos en curso",
        header_legacy: "Proyectos antiguos",
        header_privacy: "Política de privacidad",
        header_terms: "Términos de servicio",
        ...
        back_to_terms: "Volver a la lista de términos",
        terms_desc: "Términos de servicio con respecto a los servicios desarrollados.",
        social_github: "GitHub",
        social_instagram: "Instagram",
        social_naverblog: "Naver Blog",
        header_prod_web: "Premium Web App",
        ...
        privacy_v5: "Política de Privacidad (Tuktak AI Composer)",
        terms_ihaveacat: "Términos de servicio (Yo también tengo un gato)",
        terms_tuktak: "Términos de servicio (Tuktak AI Composer)",
    ...
    zh: {
        ...
        back_to_terms: "返回条款列表",
        terms_desc: "关于所开发服务的服务条款。",
        social_github: "GitHub",
        social_instagram: "Instagram",
        social_naverblog: "Naver Blog",
        header_prod_web: "Premium Web App",
        ...
        privacy_v4: "隐私政策 (小猫)",
        privacy_v5: "隐私政策 (Tuktak AI 作曲家)",
        terms_ihaveacat: "服务条款 (我也有猫)",
        terms_tuktak: "服务条款 (Tuktak AI 作曲家)",
    ...
    ja: {
        ...
        privacy_v5: "個人情報処理方針 (Tuktak AI 作曲家)",
        terms_ihaveacat: "サービス利用規約 (私も猫がいる)",
        terms_tuktak: "サービス利用規約 (Tuktak AI 作曲家)",
